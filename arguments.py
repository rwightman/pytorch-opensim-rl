...
def get_args():
    ...
    parser.add_argument('--lr-schedule', type=float, default=None,
                        help='learning rate schedule (decay steps) (default: None)')
    ...
    parser.add_argument('--clip-action', action='store_true', default=False,
                        help='clip actions')
    parser.add_argument('--shift-action', action='store_true', default=False,
                        help='shift action to mean and rescale')
